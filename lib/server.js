...
class Server {
  constructor (options) {
    ...
    this.pusherHost = options.pusherHost
    this.pusherPort = options.pusherPort
  ...
  async start () {
    ...
    const pubSubGateway = new PubSubGateway(this.pusherHost ? {
      appId: this.pusherAppId,
      key: this.pusherKey,
      secret: this.pusherSecret,
      cluster: this.pusherCluster,
      host: this.pusherHost,
      port: this.pusherPort
    } : {
      appId: this.pusherAppId,
      key: this.pusherKey,
      secret: this.pusherSecret,
